...
set JARPATH=%APP_HOME%\lib\car-warehouse-service-1.0-SNAPSHOT.jar

@rem Execute car-warehouse-service
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CAR_WAREHOUSE_SERVICE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
